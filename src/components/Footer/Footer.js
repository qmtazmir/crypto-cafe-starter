    ...
    <footer className="bg-white  w-full py-8 mt-8">
      <div className="max-w-screen-xl mx-auto px-4">
        <div className=" flex max-w-xs mx-auto items-center justify-between">
          <a href="https://www.facebook.com/tazmir9/" className="text-gray-400 hover:text-gray-800 transition-colors duration-200">
            <svg
              width="20"
              height="20"
              fill="currentColor"
          ...
          <a href="https://github.com/qmtazmir" className="text-gray-400 hover:text-gray-800 transition-colors duration-200">
            <svg
              width="20"
              height="20"
              fill="currentColor"
